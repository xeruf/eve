...
SCENARIO("A world can be created and initialised") {
    GIVEN("An empty world is instantiated") {
        ...
        world = new World(1000, 1000, worldE);
...
SCENARIO("The world can freely be modified") {
    GIVEN("And instantiated and filled world") {
        ...
        WHEN("I kill all individuals") {
            for (auto individual : world->getIndividuals()) {
                ...
                THEN("the amount of individuals decreases meanwhile") {
